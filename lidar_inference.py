...
if __name__ == "__main__":
    ...
    # Define custom feature and label ranges
    feature_range_X = (0, 12000)
    feature_range_Y = (0, 2)

    # Normalize the output labels to the range [0, 1]
    X_normalized = (fake_lidar_data - feature_range_X[0]) / (feature_range_X[1] - feature_range_X[0])
    X_mapped = (X_normalized * 255).astype(np.uint8)
    ...
    # print("Output Shape:", output_values.shape)
    print("Output Values:", prediction_reversed)
